...
/** Review lifecycle for a developer discovered outside [pl.marcinwieczorek.investmentmonitor.registry.DeveloperRegistry]. */
enum class DeveloperCandidateStatus {
    ...
    /** Promoted to [pl.marcinwieczorek.investmentmonitor.registry.DeveloperRegistry] with a working adapter. */
    IMPLEMENTED,
 ...
 * whose developer is not yet in [pl.marcinwieczorek.investmentmonitor.registry.DeveloperRegistry].
 *
