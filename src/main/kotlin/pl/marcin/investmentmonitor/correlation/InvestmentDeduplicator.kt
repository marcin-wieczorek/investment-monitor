 ...
 * [pl.marcin.investmentmonitor.persistence.InvestmentRepository.findIdByCanonicalKey])
 * and persists the result as a [pl.marcin.investmentmonitor.domain.InvestmentDuplicate].
 */
