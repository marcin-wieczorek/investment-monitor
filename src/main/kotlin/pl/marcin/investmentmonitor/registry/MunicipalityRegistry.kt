...
import pl.marcin.investmentmonitor.domain.Municipality
import pl.marcin.investmentmonitor.domain.MunicipalitySourceStatus
...
object MunicipalityRegistry {
    ...
    val ALL: List<Municipality> = listOf(
        ...
        m("buk", "Buk", "poznański", MunicipalitySourceStatus.IMPLEMENTED, MunicipalitySourceStatus.BLOCKED, MunicipalitySourceStatus.NOT_IMPLEMENTED),
        ...
        m("dopiewo", "Dopiewo", "poznański", MunicipalitySourceStatus.IMPLEMENTED, MunicipalitySourceStatus.BLOCKED, MunicipalitySourceStatus.NOT_IMPLEMENTED),
        m("kleszczewo", "Kleszczewo", "poznański", MunicipalitySourceStatus.IMPLEMENTED, MunicipalitySourceStatus.BLOCKED, MunicipalitySourceStatus.NOT_IMPLEMENTED),
        ...
        m("kornik", "Kórnik", "poznański", MunicipalitySourceStatus.NOT_IMPLEMENTED, MunicipalitySourceStatus.NOT_IMPLEMENTED, MunicipalitySourceStatus.NOT_IMPLEMENTED),
        ...
        m("murowana_goslina", "Murowana Goślina", "poznański", MunicipalitySourceStatus.IMPLEMENTED, MunicipalitySourceStatus.NOT_IMPLEMENTED, MunicipalitySourceStatus.NOT_IMPLEMENTED),
        m("oborniki", "Oborniki", "obornicki", MunicipalitySourceStatus.NOT_IMPLEMENTED, MunicipalitySourceStatus.BLOCKED, MunicipalitySourceStatus.NOT_IMPLEMENTED),
        m("pobiedziska", "Pobiedziska", "poznański", MunicipalitySourceStatus.IMPLEMENTED, MunicipalitySourceStatus.BLOCKED, MunicipalitySourceStatus.NOT_IMPLEMENTED),
        ...
        m("skoki", "Skoki", "wągrowiecki", MunicipalitySourceStatus.NOT_IMPLEMENTED, MunicipalitySourceStatus.BLOCKED, MunicipalitySourceStatus.NOT_IMPLEMENTED),
        m("steszew", "Stęszew", "poznański", MunicipalitySourceStatus.NOT_IMPLEMENTED, MunicipalitySourceStatus.BLOCKED, MunicipalitySourceStatus.NOT_IMPLEMENTED),
        ...
        m("szamotuly", "Szamotuły", "szamotulski", MunicipalitySourceStatus.IMPLEMENTED, MunicipalitySourceStatus.BLOCKED, MunicipalitySourceStatus.NOT_IMPLEMENTED),
        m("srem", "Śrem", "śremski", MunicipalitySourceStatus.IMPLEMENTED, MunicipalitySourceStatus.NOT_IMPLEMENTED, MunicipalitySourceStatus.NOT_IMPLEMENTED),
