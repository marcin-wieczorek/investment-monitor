...
class SivanetSource(
    ...
    private val parser: SivanetParser = SivanetParser()
) : InvestmentSource {

    override val id: String = SivanetParser.SOURCE_ID
    ...
    companion object {
        const val LIST_URL = "https://sivanet.pl/nieruchomosci/lechicka-65/"
    }
}
