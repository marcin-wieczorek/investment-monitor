...
class MurapolSource(
    ...
    private val parser: MurapolParser = MurapolParser()
) : InvestmentSource {

    override val id: String = MurapolParser.SOURCE_ID
    ...
    companion object {
        const val LIST_URL = "https://murapol.pl/oferta/poznan/mieszkania"
    }
}
