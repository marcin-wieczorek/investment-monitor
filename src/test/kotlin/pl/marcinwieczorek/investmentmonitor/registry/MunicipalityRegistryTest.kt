...
class MunicipalityRegistryTest {
    ...
    fun `swarzedz has full source coverage`() {
        ...
        swarzedz?.developerCoverage shouldBe pl.marcinwieczorek.investmentmonitor.domain.MunicipalitySourceStatus.IMPLEMENTED
        swarzedz?.discoveryCoverage shouldBe pl.marcinwieczorek.investmentmonitor.domain.MunicipalitySourceStatus.IMPLEMENTED
    }
